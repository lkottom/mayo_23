...
class Autoencoder(nn.Module):
    def __init__(self, patch_size, input_channels=3, latent_dim=16):
        super().__init__()
        ...
        self.fc_mu = nn.Linear(hidden_sizes[4], latent_dim)
        self.fc_logvar = nn.Linear(hidden_sizes[4], latent_dim)
