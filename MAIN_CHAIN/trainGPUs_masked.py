...
parser.add_argument('--batch_size_test', type=int, default=16, metavar='N')
...
# ## ---------------------------------------------------
train_dataset = CustomDataset(data_path='/mayo_atlas/home/m296984/MAIN_CHAIN_BREAST_RESULTS/train_16x16_patches', transform=transform)
...
def train(epoch):
    ...
    for batch_idx, (data, _) in enumerate(train_loader):
        ...
        # Run VAE
        recon_batch, mu, logvar = model(masked_image)
        # Compute loss
        rec, kl = model.loss_function(recon_batch, data, mu, logvar, masked_image)
...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        scheduler.step()
        os.makedirs(f'/mayo_atlas/home/m296984/MAIN_CHAIN_BREAST_RESULTS/vae_logs_masked/{args.log_dir}', exist_ok=True)
        torch.save(model.module.state_dict() if isinstance(model, nn.DataParallel) else model.state_dict(),
                '/mayo_atlas/home/m296984/MAIN_CHAIN_BREAST_RESULTS/vae_logs_masked/{}/checkpoint_{}.pt'.format(args.log_dir, str(epoch)))
