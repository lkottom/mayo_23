...
if __name__ == "__main__":
    ...
    for size in patch_size:
        num_of_words = 8000
        wsi_dir = f'/mayo_atlas/home/m296984/MAIN_CHAIN/train_liver_data'
        save_dir = f'/mayo_atlas/home/m296984/MAIN_CHAIN/training_{size}x{size}_patches_1'
        ...
        for file in tqdm.tqdm(os.listdir(wsi_dir), total=len(os.listdir(wsi_dir)), desc="Getting Words: "):
            if file.endswith('.svs'):
                ...
                image_list = process_wsi(wsi_path, number_of_words_per_patch=words_per_patch, word_size=size, output_patch_size=1024)
