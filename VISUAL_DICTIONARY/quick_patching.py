...
# Setting a random seed for testing process and reproducibility of results
random_seed = 2969
...
def extract_patches_from_numpy(patch_list, patch_size=32, num_words=100, min_tissue_percentage=90):
    ...
    for image in patch_list:
        ...
        patches_saved = 0
        attempts = 0 
        # Set the max attempts until it moves on to the next sample (10**6 seems to work well and efficiently)
        max_attempts = 10**6
        
        while patches_saved < num_words and attempts < max_attempts:
