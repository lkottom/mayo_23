...
class Autoencoder(nn.Module):
    ...
    This class defines and autoencoder model composed of a encoder and decoder. This 
    autoencoder is a convolutional autoencdoer that is connected by 3 convolutional layers, followed
    by a ReLU and a MaxPool2d activation layers. 
    
    Args:
        latent_dim (int): length of the embedding generated after the encoder layer (default: 16)
